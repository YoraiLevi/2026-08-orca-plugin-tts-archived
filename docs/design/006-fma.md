...
| 14 | the modules the Lab imports → **the resolver that ships** | every module must load under **plain node**, not only under vitest's resolver | **SC-14** | **OPEN, blocking** — R10-06 |
